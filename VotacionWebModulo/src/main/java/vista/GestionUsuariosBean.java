...
/*	@Inject
	...
	private Candidato usuario = getUser();
	...
	private List<Candidato> usuarios;
	...
	public void setUsuarios(List<Candidato> usuarios) {
	...
	public void validarUsuario(FacesContext context, UIComponent comp, Object value) {
		String ced = (String) value;
		System.out.println("cedula"+ced);
		Candidato u = gl.recuperarUsuario(ced);
		if (u != null && u.getUs_contrasena() != null) {
	...
	public List<Candidato> recuperarUsuarios(){
	...
	public void recuperarUsuario(String us_cedula) {
		Candidato u = gl.recuperarUsuario(us_cedula);
		this.us_cedula = us_cedula;
	...
	private Candidato getUser() {
		FacesContext context = FacesContext.getCurrentInstance();
        HttpSession session = (HttpSession) context.getExternalContext().getSession(true);
        return (Candidato) session.getAttribute("user");
	}
