...
public class ServicesSoap {
	...
	@WebMethod
	public Respuesta Votar(String cedula, String nombre, String candidato){
		Respuesta res = new Respuesta();
		try {
			glu.agregarVoto(cedula, nombre, candidato);
			res.setCodigo(1);
			res.setMensaje("Voto aceptado");
		}catch(Exception e) {
			res.setCodigo(505);
			res.setMensaje("Error al votar");
		}
		return res;
	}
